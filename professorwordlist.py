...
%%d : digit          %%l : lowercase letter      %%w : Wordlist word's 
%%s : symbol         %%L : Uppercase letter      %%W : Custom Word/s         
%%X : Custom List    %%Y : Custom list #2        %%Z : Custom list #3
''')

parser.add_argument('-C', '--custom', type=str, metavar='\b', default='',
                    help='    A custom list for characters of your choice, replace %%X. Example: test_%%X -C "ÀÐÈ123&!"')
...
parser.add_argument('-W', '--words', type=str, nargs="+", default="[]", metavar='',
                    help="Replace %%W, please add words")
